...
struct ContentView: View {
    ...
    var body: some View {
        ...
        /* Need to figure out why tag/tokens are not working below in searchable... For now taking out that functionality. Should read "Filter issues, or type # to add tags"*/
